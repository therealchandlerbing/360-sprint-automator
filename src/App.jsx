...
// HTML Template for professional document export
const HTML_TEMPLATE = (content, title, projectName, stepName, date) => `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
            ...
            {completedSteps > 0 && (
              <div style={{ padding: '16px', borderTop: `1px solid ${COLORS.border}` }}>
                ...
                <div style={{ display: 'flex', gap: '8px', marginTop: '8px' }}>
                  <button onClick={downloadAllOutputs} style={{ ...styles.downloadAllButton, flex: 1, backgroundColor: COLORS.primaryLight }}>
                    ↓ MD
                  </button>
                  <button onClick={downloadAllOutputsAsHtml} style={{ ...styles.downloadAllButton, flex: 1, backgroundColor: COLORS.primaryAccent }}>
                    ↓ HTML
                  </button>
                </div>
              </div>
            ...
            <div style={{ ...styles.card, marginTop: '24px' }}>
              <div className="output-header" style={styles.outputHeader}>
                ...
                <div className="output-buttons" style={{ display: 'flex', gap: '8px' }}>
                  ...
                  <button onClick={() => downloadOutputAsHtml(currentStep)} style={{ ...styles.downloadButton, backgroundColor: COLORS.primaryAccent }}>
                    ↓ HTML
                  </button>
                </div>
              </div>
